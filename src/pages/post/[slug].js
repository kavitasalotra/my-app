  ...
  return (
    <Layout>
      <div className="container mx-auto px-8 py-4 lg:py-8 mx-auto xl:px-5 max-w-screen-lg post-header text-center">
        ...
        <div className="my-5">
          <Image
            className="object-cover w-full rounded-lg md:h-472 md:w-265 md:rounded-none md:rounded-lg object-cover"
        ...
        <main className="max-w-3xl mx-auto  my-4 text-left prose prose-a:text-blue-500">
          ...
          <div className="text-center">
            <a
              className="text-sky-500 inline-flex items-baseline  text-sm"
              href="/"
            >
              <BsArrowLeft className="mr-2" /> View all post
            </a>
          </div>
            ...
            <div className="flex justify-center items-center flex-wrap">
              ...
              <div className="m-4 max-w-xl">
                <a
                  ...
                  className="group"
                >
                  <h4 className="text-lg leading-6 text-neutral-800 group-hover:text-skin-primary">
                    About {frontMatter.AuthorName}
                  </h4>
                </a>
