            ...
            <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-center">
              <div className="hidden sm:block sm:ml-6">
                <div className="flex space-x-4">
                  ...
                  <a href="#" className=" text-gray-600   hover:text-blue-400 px-5 py-2 rounded-md text-sm font-medium">Github</a>
                  <a href="#" className=" text-gray-600  hover:text-blue-400 px-5 py-2 rounded-md text-sm font-medium">Download</a>
                </div>
              </div>
            </div>
          </div>
