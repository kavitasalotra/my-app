...
const Header = () => {
  ...
  return (
    <div className="container mx-auto py-5 px-4">
          ...
          <div className=" flex items-center justify-between h-16">
            ...
            <div className=" flex items-center sm:hidden">
              <button
                ...
                type="button"
                className="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-200 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white ml-28"
            ...
            <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-center">
              <div className="hidden sm:block sm:ml-6">
                <div className="flex space-x-4">
                  <Link href="/">
                    <a
                      className=" text-gray-600  hover:text-blue-400  px-5 py-2 rounded-md text-sm font-medium"
                      aria-current="page"
                    >
                      Home
                    </a>
      ...
      {active && (
        <div className="sm:hidden flex flex-col text-center bg-white  pt-6 w-full">
          <Link href="/">
            <a
              className="text-gray-600  hover:text-blue-400  px-5 py-2 rounded-md text-sm font-medium"
              aria-current="page"
