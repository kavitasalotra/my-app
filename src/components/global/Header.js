            ...
            <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
              <button type="button" className="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white" aria-controls="mobile-menu" aria-expanded="false">
                ...
                <svg className="hidden h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" aria-hidden="true">
                  <path strokeLinecap="round" strokeLinejoin="round" id="M6 18L18 6M6 6l12 12" />
                </svg>
              </button>
            </div>
            <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-center">
              <div className="hidden sm:block sm:ml-6">
                <div className="flex space-x-4">
                  <a href="#" className=" text-gray-600 px-5 py-2 rounded-md text-sm font-medium" aria-current="page">Home</a>
                  <a href="#" className=" text-gray-600 hover:bg-gray-700 hover:text-white px-5 py-2 rounded-md text-sm font-medium">About</a>
                  <a href="#" className=" text-gray-600 hover:bg-gray-700 hover:text-white px-5 py-2 rounded-md text-sm font-medium">Contact</a>
                  ...
                  <a className=" text-gray-600  hover:bg-gray-700 hover:text-white px-5 py-2 rounded-md text-sm font-medium" href="#">Archieve</a>
                  <a href="#" className=" text-gray-600  hover:bg-gray-700 hover:text-white px-5 py-2 rounded-md text-sm font-medium">Github</a>
                  <a href="#" className=" text-gray-600  hover:bg-gray-700 hover:text-white px-5 py-2 rounded-md text-sm font-medium">Download</a>
                </div>
              </div>
            </div>
          </div>
